...
Все желающие попробовать свои силы в написании "ИИ" для этой имитационной модели должны прислать свои результаты **не позднее 7 апреля 16:00** по [ссылке](https://www.dropbox.com/request/hCtzOaqvFZoTMYKpDf4P) (после указанной даты ссылка не будет работать)

![](imgs/qr-code.png)

Основным результатом является 1 питоновский 🐍 файл, внутри которого должна быть Ваша функция управления и всё необходимое для её работы. Шаблон такого файла можно глянуть [тут](https://github.com/TovarnovM/duel_im/blob/master/sample.py). В файле необходимо указать имя автора, его контактные данные, список необходимых установочных пакетов, необходимых для работы функции (все необходимые пакеты должны быть доступны к установке через [pip](https://ru.wikipedia.org/wiki/Pip_(%D0%BC%D0%B5%D0%BD%D0%B5%D0%B4%D0%B6%D0%B5%D1%80_%D0%BF%D0%B0%D0%BA%D0%B5%D1%82%D0%BE%D0%B2)))

## Определение победителя

Все присленные участниками "боты" будут состязаться против друг друга по круговой системе (каждый с каждым). Участник, победивший в бОльшем количестве схваток объявляется победителем и получит почёт и ценные призы)

## Подведение итогов

Подведение итогов конкурса будет проходить **9 апреля** на кафедре СМ6 (точное время будет уточнено ближе к дате проведения и сообщено по электронным почтам участников). Каждый участник может подготовить короткое сообщение-презентацию по результатам своей работы, в которой он может рассказать о процессе разарботки, о трудностях и особенностях, возникших в ходе работы, и о полученных результатах. Такое сообщение будет очень приветствоваться.

По всем конкурсным вопросам можно обращаться к Товарнову Михаилу Степановичу по почте mtovarnov@mail.ru или в [вк](https://vk.com/id854957)

## P.S.

Данный конкурс организуется не только с целью нахождения лучшей фукнции управления треугольника и материальной поддержки студентов, но и с целью нахождения переспективных людей, с которыми можно работать над актуальными и востребованными научными проектами. Поэтому в конкурсе есть дополнительное задание, о котором можно спросить у организаторов конкурса.
